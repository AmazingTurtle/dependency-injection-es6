...
var Container = (function () {
    ...
    _createClass(Container, null, [{
        ...
        key: "getInstanceOf",
        value: function getInstanceOf(clazz, ...params) {
        ...
        key: "resolve",
        value: function resolve(clazz, ...params) {
        ...
        key: "resolveInstance",
        value: function resolveInstance(clazz, ...params) {
            ...
            return new (_bind.apply(clazz, [null].concat(_toConsumableArray(dependencies)).concat(params)))();
        }
    }, {
